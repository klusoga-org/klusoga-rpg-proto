...
func _ConfigService_GetRpgConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ConfigServiceServer).GetRpgConfig(ctx, in)
	}
...
var ConfigService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRpgConfig",
			Handler:    _ConfigService_GetRpgConfig_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/config/configService.proto",
}
